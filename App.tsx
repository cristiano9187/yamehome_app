      ...
      <div className="min-h-screen bg-gray-900 text-white p-6 font-sans flex flex-col items-center">
        <div className="w-full max-w-md bg-gray-800 p-6 rounded-lg border border-blue-500/30 shadow-2xl">
          ...
          <div className="space-y-4">
            ...
            <textarea rows={2} className="w-full bg-gray-700 rounded p-2 text-[11px] border border-red-900/30 outline-none" placeholder="Casse ?" onChange={(e) => setCleaningReport({...cleaningReport, damages: e.target.value})}></textarea>
      ...
      <div className="w-full md:w-1/3 p-6 overflow-y-auto h-auto md:h-screen print:hidden shadow-2xl border-r border-gray-800">
        <div className="mb-6 flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => { setFormData(getInitialState()); setIsReadOnly(false); setSearchId(''); }} className="bg-red-600 hover:bg-red-700 px-2 py-1 rounded font-bold uppercase transition-all shadow-lg text-[9px]">Nouveau</button>
          </div>
        </div>
        <div className="bg-blue-900/20 p-4 rounded border border-blue-500/30 mb-6 text-center">
          <div className="flex gap-2">
            <input type="text" placeholder="Recharger ID..." className="flex-1 bg-gray-800 rounded p-2 border border-blue-400/50 outline-none" value={searchId} onChange={(e) => setSearchId(e.target.value)} />
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="bg-gray-800 p-4 rounded border border-gray-700 shadow-sm">
            ...
            {TARIFS[formData.apartmentName]?.units && TARIFS[formData.apartmentName].units!.length > 1 && (
              <div className="mb-3 p-2 bg-blue-900/30 border border-blue-500/50 rounded text-center animate-pulse">
